...
An initial version of this example was created before 2020 and was relying on `setup.py`.  
It has been re-written in 2024 to demonstrate the use of `pyproject.toml` for packaging.
